...
def build_packet() -> dict[str, Any]:
    ...
    channels = [
        ...
        },
        {
            ...
            "required_before_enablement": [
                "verify crates.io account email address",
                "rerun cargo publish order",
                "record cargo owner evidence after publication",
            ],
            "evidence": [
                "zero-os namespace availability checked",
    ...
    return {
        ...
        "summary": {
            ...
            "current_release": "v0.1.2",
            "policy": "PyPI zero-engine is published through Trusted Publishing; crates.io zero-os is wired and publish-ready but blocked on crates.io account email verification; Docker Hub and GHCR stay blocked until ownership, provenance, and rollback evidence are recorded.",
        },
        "channels": channels,
        "checks": checks,
